...
class ContratadoUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'cpf' => ['required', 'string', 'unique:contratados,cpf,' . $contratadoId, new Cpf],
            'rg' => 'nullable|string|max:20',
            'formacoes' => 'nullable|string',
    ...
    public function messages(): array
    {
        return [
            ...
            'formacoes.string' => 'O campo formação deve ser uma string.',
            'habilidades.string' => 'O campo habilidades deve ser uma string.',
            'experiencias.string' => 'O campo experiencias deve ser uma string.',
